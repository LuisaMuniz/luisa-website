        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Card className="hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-8">
              ...
              <p className="text-blue-600 font-medium mb-4">Capilano University • Vancouver, Canada</p>
          ...
          <Card className="hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-8">
              ...
              <p className="text-blue-600 font-medium mb-4">University of Hertfordshire • Hatfield, England</p>
              <p className="text-slate-600">
